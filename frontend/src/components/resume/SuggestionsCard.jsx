...
export default function SuggestionsCard({ suggestions = [], onGenerate }) {
  return (
    <div className="rounded-2xl p-6 flex flex-col gap-5" style={{ background: "var(--bg-card)", border: "0.5px solid var(--border)" }}>
      ...
      <button
        onClick={onGenerate}
        className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl text-white font-bold text-sm tracking-wide transition-opacity hover:opacity-90 btn-gradient"
      >
