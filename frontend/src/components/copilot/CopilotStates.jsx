...
export function CopilotLoadingState() {
  return (
    <div className="grid grid-cols-1 xl:grid-cols-[1fr_340px] gap-6">
      ...
      <div className="flex flex-col gap-6">
        {[1, 2, 3].map((i) => (
          <div key={i} className="rounded-2xl p-6" style={{ background: "#0d1117", border: "0.5px solid #1e2535" }}>
...
export function CopilotEmptyState({ onPromptClick }) {
  return (
    <div className="flex flex-col items-center justify-center py-24 gap-6 text-center">
      ...
      <div>
        <h3 className="text-white text-xl font-bold mb-2">Ask your first career question.</h3>
